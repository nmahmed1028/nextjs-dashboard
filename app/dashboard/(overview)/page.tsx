...
//import { fetchCardData } from '@/app/lib/data'; //fetch data for Card component
...
export default async function Page() { //async --> allows use of await to fetch data
    ...
    //const latestInvoices = await fetchLatestInvoices(); //get 5 latest invoices from data file
    /*const {
        totalPaidInvoices, 
